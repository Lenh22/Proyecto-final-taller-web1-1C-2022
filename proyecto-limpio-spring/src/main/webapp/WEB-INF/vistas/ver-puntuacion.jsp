    ...
    <div class = "container">
        <div id="loginbox" style="margin:7em;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <c:if test="${empty error}" >
                <h2 class="w3-opacity w3-center">Puntuación total</h2>
                <div class="w3-panel w3-blue w3-center" style="background-color: #999999">
                    <h3 class="glyphicon glyphicon-education" > La puntuacion actual del roomie con mail ${roomie} es de: ${puntaje}%</h3>
                </div>
            </c:if>
