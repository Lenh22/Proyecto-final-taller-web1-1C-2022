...
<div class="w3-top">
    <div class="w3-bar w3-black w3-card">
        ...
        <a href="#band" class="w3-bar-item w3-button w3-padding-large w3-hide-small">VIVIENDAS</a>
        <a href="#tour" class="w3-bar-item w3-button w3-padding-large w3-hide-small">ROOMIES</a>
        <a href="#contact" class="w3-bar-item w3-button w3-padding-large w3-hide-small">RECOMENDACIONES</a>
