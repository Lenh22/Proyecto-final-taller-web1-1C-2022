...
<div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
    ...
    <p class="w3-opacity"><i>La manera mas facil de encontrar inquilinos</i></p>
    <p class="w3-justify">Te brindamos las precauciones y comodidades para que puedas alquilar tu habitacion o departamento</p>
</div>
