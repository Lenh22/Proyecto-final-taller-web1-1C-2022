            ...
            <div>
                <div class="w3-card w3-container" style="min-height:auto">
                    <div style="display: flex;justify-content: space-between;">
                        ...
                        <a href="#" class="w3-button w3-black w3-section w3-right" Type="Submit"
                           style="max-height: 2.8em; align-self: flex-end;"/>Perfil</a>
                    </div>
                </div>
            </div>
            </c:forEach>
...
<footer class="w3-container w3-padding-64 w3-center w3-opacity w3-black w3-xlarge">
    ...
    <p class="w3-medium"><a href="https://github.com/Lenh22/Proyecto-final-taller-web1-1C-2022" target="_blank">Repositorio</a>
    </p>
