...
<div class = "container">
    <div id="loginbox" style="margin:7em;" class="mainbox col-md-1 col-md-offset-3 col-sm-8 col-sm-offset-2">
        ...
        <form:form  action="agregar-vivienda" method="post" modelAttribute="datosVivienda" >

            <h2 class="w3-opacity w3-center"> Agregue los datos de la vivienda </h2>
            <%--Elementos de entrada de datos, el elemento path debe indicar en que atributo del objeto usuario se guardan los datos ingresados--%>

            <form:input class="w3-input w3-border" path="direccion" id="email" type="text" placeholder="Ingrese la direccion"/>
            <br>
            <form:input class="w3-input w3-border" path="cantidadMaximaRoomies" type="number" id="cantidadMaximaRoomies" placeholder="Ingrese la cantidad de inquilinos permitidos"/>
            <br>
            <form:input class="w3-input w3-border" path="descripcion" id="email" type="text" placeholder="Ingrese una descripcion"/>
            <br>
