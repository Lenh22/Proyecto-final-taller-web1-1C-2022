...
<script type="text/javascript">
    ...
    function ConfirmDenuncia(){
        var respuesta = confirm("Estas seguro de denunciar al usuario?");
...
<div class = "container">
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        ...
        <form:form action="denunciaValidacion" method="post" modelAttribute="datosDenuncia"  >
            <h2 class="w3-opacity w3-center">Denuncie a los usuarios</h2>
            <p class="w3-opacity">Lo que nos diferencia como empresa es que queremos dar soluciones, sin importar quien sea. Si tienes un problema con alguno de nuestros usuarios por favor haganos saber. Nosotros tomaremos las medidas necesarias</p>
            <%--Elementos de entrada de datos, el elemento path debe indicar en que atributo del objeto usuario se guardan los datos ingresados--%>

            <form:input class="w3-input w3-border" path="email" id="email" type="email" placeholder="Ingrese email del usuario que desea denunciar" />
            <br>
            <button class="w3-button w3-black w3-section w3-right" Type="Submit" onclick="return ConfirmDenuncia()"/>denunciar</button>
        </form:form>
