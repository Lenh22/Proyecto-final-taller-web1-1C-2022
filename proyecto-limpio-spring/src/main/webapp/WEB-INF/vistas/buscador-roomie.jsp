...
<div class="w3-top">
    <div class="w3-bar w3-black w3-card">
        ...
        <div class="w3-dropdown-hover w3-hide-small">
            ...
            <div class="w3-dropdown-content w3-bar-block w3-card-4">
                ...
                <a href="#" class="w3-bar-item w3-button">ROOMIES</a>
            </div>
        </div>
    </div>
</div>
    <div class = "container">
        ...
        <form:form action="validar-buscador-roomie" method="POST" modelAttribute="datos">
           <form:input path="nombre" id="nombre" type="text" placeholder="Ingrese el nombre del usuario buscado" class="w3-input w3-border"/>
        ...
        <h2 class="w3-opacity w3-center">Todos los Roomies disponibles</h2>
                ...
                <div class="w3-card w3-container" style="min-height:auto">
                    <div style="display: flex;justify-content: space-between;">
                        ...
                        <div style="size: 16px!important;">
                            <p>Nombre: ${roomie.nombre} ${roomie.apellido}</p>
                            <p>Contacto: ${roomie.email}</p>
                            <p>Edad: ${roomie.edad} </p>
                        </div>
        ...
        ${msg}
            ...
            <a href="buscador-roomie" class="w3-button w3-black w3-section w3-center" Type="Submit" style="max-height: 2.8em;"/>Volver al listado</a>
